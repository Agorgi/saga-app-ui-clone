...
export const PrevButton: React.FC<ButtonProps> = ({
  ...
  const buttonClassName = className
    ? `embla__button embla__button--prev ${className}`
    : 'embla__button embla__button--prev';
  const svgClass = svgClassName ? `embla__button__svg ${svgClassName}` : 'embla__button__svg';

  return (
    <button className={buttonClassName} type="button" {...restProps}>
      <svg className={svgClass} viewBox="0 0 532 532">
...
export const NextButton: React.FC<ButtonProps> = ({
  ...
  const buttonClassName = className
    ? `embla__button embla__button--next ${className}`
