...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@saga/events-middleware': path.resolve(__dirname, './src/vendor/saga-shims/events-middleware.ts'),
      '@saga/crowd-commission-middleware': path.resolve(__dirname, './src/vendor/saga-shims/crowd-commission-middleware.ts'),
